...
def predict():
    ...
    input('BloodPressure', name='bloodpressure', placeholder="e.g. 66", type=NUMBER),
    input('SkinThickness', name='SkinThickness', placeholder="e.g. 35", type=NUMBER)
    ])
    ...
    fetch_data = np.array([[glucose, insulin, bmi, age,bloodpressure,SkinThickness]])
